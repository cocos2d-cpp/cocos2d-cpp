...
void Bug914Layer::onTouchesMoved(const std::vector<Touch*>& touches, Event *)
{
...
void Bug914Layer::restart(Ref*)
{
    Director::getInstance()->replaceScene( to_node_ptr(Bug914Layer::create()) );
}
